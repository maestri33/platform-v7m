...
# Sobe e verifica notify, worker, PostgreSQL, Redis, Evolution v2 e Evolution GO
...
URLs locais: notify `http://127.0.0.1:8000`, Evolution v2
`http://127.0.0.1:18080` e Evolution GO `http://127.0.0.1:4000`.
