        ...
        >
          ...
          <div className="w-full rounded-[18px] border border-brand-blue/15 bg-brand-blue/5 p-4">
            ...
            <input
              ...
              className={`min-h-[58px] w-full rounded-[14px] border-[1.5px] bg-white/60 px-4 text-center text-[23px] font-bold tracking-[0.06em] text-brand-ink outline-none backdrop-blur-md placeholder:font-normal placeholder:text-brand-muted/70 ${
