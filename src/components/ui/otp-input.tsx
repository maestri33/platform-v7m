      ...
      {Array.from({ length }, (_, i) => {
        ...
        return (
          <input
            ...
            className={`h-16 w-full min-w-0 rounded-2xl border-2 bg-white/60 text-center text-2xl font-extrabold text-brand-ink outline-none backdrop-blur-md transition focus:border-brand-blue-bright focus:ring-4 focus:ring-brand-blue-bright/25 disabled:bg-brand-bg ${
              invalid
                ? "border-brand-danger"
                : filled
