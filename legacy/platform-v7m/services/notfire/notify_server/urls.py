...
_dashboard_urls = [
    ...
    path("dashboard/watchdog", dashboard.watchdog_panel),
    path("dashboard/watchdog/run", dashboard.watchdog_run),
    path("dashboard/canary/run", dashboard.canary_run),
    ...
    path("dashboard/app/<slug:slug>/mail/dns", dashboard.mailcow_dns),
