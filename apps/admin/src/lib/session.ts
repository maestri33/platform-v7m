 ...
 * phone -> identifica o staff no check/resend (canal do OTP é o WhatsApp do número).
 * externalId (UUID) -> login flow. cpf mantido por compat (telas de usuários).
