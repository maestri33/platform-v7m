    ...
    accepts: [
      {
        ...
        network: "eip155:8453",
        amount: "1000",
        resource: "https://maestri.group/api",
        description:
          "V7M Educational & Commercial agent API, payable via x402 on Base (USDC). Free discovery stays open at /openapi.json, /.well-known/* and /api/v1.",
