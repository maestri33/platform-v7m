  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 max-w-4xl mx-auto">
        {/* Banner de KYC / Ativação de Saque */}
        {!me?.pix_key && (
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <h4 className="font-bold text-amber-800">
                    Cadastro em fase de ativação
                  </h4>
                  <p className="text-amber-700 mt-0.5">
                    Você já pode divulgar seu link e acumular comissões! Para receber os pagamentos semanais via PIX, finalize seus dados.
                  </p>
                </div>
              </div>
              <Link href="/onboarding" className="shrink-0">
                <Button size="sm" className="w-full sm:w-auto bg-amber-600 hover:bg-amber-700 text-white font-bold text-xs">
                  Completar Cadastro
                </Button>
              </Link>
            </div>
