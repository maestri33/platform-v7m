/**
 * Funil do lead — dados e contratos das telas.
 *
 * Fonte da verdade: `Lead Supletivo (protótipo).dc.html` + DOCUMENTACAO.md do
 * projeto de design. O funil fala com o backend REAL via `lead-api.ts`; os
 * GATILHOS determinísticos do protótipo (sufixo de telefone, código fixo,
 * sufixo de CPF) continuam disponíveis atrás de `NEXT_PUBLIC_LEAD_MOCK=1`
 * (flag de BUILD) e documentam o contrato que a API cumpre.
 */
