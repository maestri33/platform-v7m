...
/** Marca do Pix — o teal #32BCAD é a cor oficial do arranjo, não um token nosso. */
    ...
    <FunnelMain width="wide">
      ...
      <div className="grid w-full grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <PricingPlanCard
          ...
          icon={<IconCreditCard className="size-7" />}
