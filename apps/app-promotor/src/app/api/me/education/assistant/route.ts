...
const rawBaseUrl = (process.env.OMNIROUTE_BASE_URL || process.env.OPENAI_BASE_URL || "http://10.0.1.35").replace(/\/+$/, "");
const BASE_URL = rawBaseUrl.endsWith("/v1") ? rawBaseUrl : `${rawBaseUrl}/v1`;
const API_KEY = process.env.OMNIROUTE_API_KEY || process.env.OPENAI_API_KEY || "sk-omniroute-default";
