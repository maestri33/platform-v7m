...
export function SelfieForm() {
  ...
  if (takenAt && status === "review") {
    return (
      <div className="space-y-3 text-center py-4">
        ...
        <Button href="/painel" variant="ghost" className="w-full">
          Voltar ao painel
        </Button>
      </div>
    );
  ...
  // Aprovada: assinatura concluída.
  if (takenAt && status === "approved") {
    return (
      <div className="space-y-4 text-center py-4">
        <div className="banner banner-ok" role="status">
          <p className="font-display text-base">Selfie e acordo aprovados ✓</p>
          <p className="text-sm mt-1 opacity-90">
            Sua identidade e assinatura foram verificadas com sucesso.
          </p>
        </div>
