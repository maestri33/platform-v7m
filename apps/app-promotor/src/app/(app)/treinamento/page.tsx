...
import { AlignLeft, ArrowLeft, FileText, Image as ImageIcon, Play } from "lucide-react";
    ...
    <PageShell>
      ...
      <div className="flex items-center justify-between pb-1">
        ...
        <span className="text-[11px] font-medium text-brand-gold-ink dark:text-brand-gold-light">
          {blockingDone.length}/{blocking.length} concluídas
        </span>
      </div>
      <CompactHeader
        kicker="V7M · Capacitação"
        title="Treinamento & Formação"
        subtitle="Conclua as matérias obrigatórias para virar Promotor Pleno e liberar o recebimento de comissões via Pix. A IA avalia na hora."
      />
      ...
      <div className="space-y-6">
        {allBlockingDone ? (
          <div className="banner banner-ok" role="status">
            <p className="font-display">✓ Matérias obrigatórias concluídas</p>
            <p className="text-sm mt-1 opacity-90">Você concluiu todo o treinamento obrigatório.</p>
          </div>
        ) : focus ? (
