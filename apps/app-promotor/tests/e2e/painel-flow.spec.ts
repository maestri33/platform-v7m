...
test.describe("Painel do Promotor & Central de Captação", () => {
  ...
  test("Visualização do link de indicação, QR Code e templates WhatsApp", async ({ page }) => {
    ...
    // 3. O modal deve exibir o QR code e permitir cópia dentro do modal
    ...
    // Template selecionado deve ser atualizado
