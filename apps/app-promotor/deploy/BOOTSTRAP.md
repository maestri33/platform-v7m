...
runner + nginx. Caddy (CT 200) tem `app.maestri.group` como placeholder reservado.
...
## 3. Caddy: ligar app.maestri.group → CT 30107:3001 (no CT 200)
...
Teste externo de `https://app.maestri.group` sai pelo exit-node Brasil (skill
