...
export default function MatriculaPage() {
  ...
  return (
    // CopilotKit: conduz o diálogo do titular do comprovante (kinship-chat, human-in-the-loop).
    // A CLASSIFICAÇÃO da foto não passa mais por aqui — é o endpoint do backend
    // `/enrollment/documents/classify` (ver classifyDocument em lib/api.ts).
    // `runtimeUrl` = o porteiro server-side (→ OmniRoute).
