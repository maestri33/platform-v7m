      ...
      >
        ...
        <div className="flex flex-col gap-2.5 px-6 pb-6 pt-4">
          ...
          <button
            type="button"
            onClick={act.collapsePlan}
            className="flex min-h-12 w-full cursor-pointer items-center justify-center rounded-xl border border-brand-border bg-transparent px-5 text-[15px] font-bold text-brand-muted transition hover:bg-black/5 hover:text-brand-ink"
          >
            ← Voltar
          </button>
        </div>
