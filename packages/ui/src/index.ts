...
export * from "./components/phone-otp-card";
export * from "./components/identity-doc-trigger-icon";
export * from "./components/identity-document-capture-flow";
export * from "./components/floating-dock";
export * from "./primitives/liquid-glass";
export { Tabs as AceternityTabs, type Tab, type TabsProps } from "./components/tabs";
